export default function Hero() {
  return (
    // ✅ Añadido id="inicio" para que el navbar pueda hacer scroll aquí
    <section id="inicio" className="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 text-white py-20 relative overflow-hidden">
